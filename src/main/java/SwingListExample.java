...
public class SwingListExample extends JPanel implements ListSelectionListener {
    private JList list;
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame("SwingListExample");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
 
        //Create and set up the content pane.
        JComponent newContentPane = new SwingListExample();
